...
model = dict(
    ...
    bbox_head=dict(
        ...
        roi_feat_size=7,
        num_classes=17,#背景类，mmdetv2则不需要加背景类
...
log_level = 'INFO'
work_dir = '/data2/pd/sdc/multidet/v0/works_dir/aedet/faster_rcnn_RoITrans_r50_fpn_1x_shipdet'
load_from = '/data2/pd/sdc/multidet/v0/works_dir/aedet/faster_rcnn_RoITrans_r50_fpn_1x_shipdet/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
