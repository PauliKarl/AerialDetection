...
log_level = 'INFO'
work_dir = '/data2/pd/sdc/multidet/v0/works_dir/aedet/faster_rcnn_obb_r50_fpn_1x_multidet'
load_from = '/data2/pd/sdc/multidet/v0/works_dir/aedet/faster_rcnn_obb_r50_fpn_1x_multidet/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
